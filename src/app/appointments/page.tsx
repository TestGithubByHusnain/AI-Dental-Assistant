          ...
          try {
            const emailResponse = await fetch("/api/send-appointment-email", {
              ...
              body: JSON.stringify({
                ...
                appointmentDate: appointment.date ? format(new Date(appointment.date), "EEEE, MMMM d, yyyy") : "",
      ...
      {bookedAppointment && (
        <AppointmentConfirmationModal
          ...
          appointmentDetails={{
            ...
            appointmentDate: bookedAppointment.date ? format(new Date(bookedAppointment.date), "EEEE, MMMM d, yyyy") : "",
              ...
              <div key={appointment.id} className="bg-card border rounded-lg p-4 shadow-sm">
                ...
                <div className="space-y-1 text-sm">
                  <p className="text-muted-foreground">
                    📅 {appointment.date ? format(new Date(appointment.date), "MMM d, yyyy") : "Date unavailable"}
                  </p>
